...
class TestOrderPageLocators:
    ...
    COUNTER_COMPLETED_FOR_ALL_TIME = By.XPATH, ".//div[@class='undefined mb-15']/p[@class='OrderFeed_number__2MbrQ text text_type_digits-large']" #Счётчик "Выполнено за всё время"
    ...
    ORDER_IN_PROGRESS = By.XPATH, ".//div[@class='OrderFeed_orderStatusBox__1d4q2 mb-15']/ul[2]/li[@class='text text_type_digits-default mb-2']"
