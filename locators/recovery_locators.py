...
class TestRecoveryLocators:
    ...
    BUTTON_EYE_PASSWORD = By.XPATH, ".//div[@class='input__icon input__icon-action']" #Кнопка-глаз в поле Пароль
    ACTIVE_PASSWORD_FIELD = By.XPATH, ".//div[@class='input pr-6 pl-6 input_type_text input_size_default input_status_active']/input[@type='text']" #Поле пароль активно для ввода